...
def main(date):
    ...
    input_path = f"gs://us-central1-airflow-dev-bcf3e1dc-bucket/data/orders_{date}.csv"
    ...
    output_path = f"gs://us-central1-airflow-dev-bcf3e1dc-bucket/output/processed_orders_{date}"
